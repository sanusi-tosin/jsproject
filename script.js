...
startBtn.addEventListener("click", () => {
    document.querySelector(`.score${points}`).classList.remove('active')
	if (!gameOn) {
		stopTimerMusic();
        resetPoints();
     ...
     // document.querySelector('score0').classList.remove('active')
...
document.querySelector('.score0') .classList.add('active')
...
answersContainer.addEventListener("click", e => {
	if (e.target.id == correctAnswer) {
        setTimeout(() => {
            ...
            correctAnswerFunc();
             document.querySelector(`.score${points}`) .classList.add('active')
            document.querySelector(`.score${points-1}`) .classList.remove('active')
            document.querySelector(`.score0`) .classList.remove('active')
        }, 1000)
